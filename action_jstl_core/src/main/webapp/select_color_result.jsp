...
<body>
	...
	<co:if test="${ param.color == 3 }">
		<span style="color:blue;"> <!-- span : 주로 꾸밀 때 많이 사용 -->
		<u>							 <!-- u : 밑줄 -->
			<i>파랑</i>
		</u>
	</co:if>
	
	<!-- choose태그 사용 : 마치 switch 처럼 -->
	<co:choose>
		<co:when test="${ param.color == 1 }"> <!-- case처럼 사용 -->
		<b>빨강</b>
		</co:when>
		
		<co:when test="${ param.color == 2 }"> <!-- case처럼 사용 -->
		<b>빨강</b>
		</co:when>
		
		<co:when test="${ param.color == 3 }"> <!-- case처럼 사용 -->
		<b>빨강</b>
		</co:when>
	</co:choose>
</body>
