...
import com.cyb.common.MySQLConnector;
...
public class MemberDAO {
	...
	public void addMember(MemberVO member) {
		try {
			...
			System.err.println("addmember() ERR : " + e.getMessage());
		}

	}

	/** 한 사람의 정보 처리 (수정링크 클릭시 : 목록화면에서) **/
	...
	public void modMember(MemberVO member) {
		try {
			connector = datasource.getConnection();
			String query = "update t_member set name=?, pwd=?, email=? where id=?";
	...
	/** 아이디 중복 처리 **/
	public boolean overlappingID(String _id) {
